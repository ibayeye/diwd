    ...
    <div className="flex justify-center items-center min-h-screen bg-slate-100">
      ...
      >
        ...
        <div className="content flex flex-col mt-5 mb-5">
          ...
          <button
            className="border mt-4 px-2 mx-10 ml-10 mr-5 rounded-md bg-blue-400 text-white"
            type="submit"
          >
            Register
          </button>
          <div className="text-xs text-end mr-5 mt-2">
            already have an account? <Link to="/login" className="text-blue-500 text-xs">Login Now</Link>
          </div>
        </div>
      </form>
    </div>
